...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-8
        ...
        .row.justify-content-center.align-items-center
          ...
          .col
            h5 Títulos valores nominativos:            
    ...
    h4 Factura cambiaria de compra y venta:    
    ...
    h5 Documento equivalente

    p Es un documento similar a la factura, no es obligatorio, pero se debe tener como soporte. Algunos ejemplos se encuentran en empresas inscritas al régimen simple que no tienen obligación de facturar:
        ...
        .row.justify-content-center.align-items-center.mt-5
          ...
          .col
            ...
            .row
                ...
                h5 Requisitos del documento equivalente:
    ...
    h4 Comprobante de egreso o comprobante de pago
    ...
    p Comúnmente se conoce como orden pago, soporte que respalda los desembolsos de efectivo, por norma de control interno realizados mediante cheques. Los comprobantes de egreso se elaboran por duplicados, para anexar a la cuenta que respalda la entrega del título valor, que es el cheque con que se efectúa el pago.
        ...
        h4 Comprobante de ingreso o comprobante de caja
        ...
        hr.mt-5
        h4 Comprobante de venta con tarjeta de crédito
        ...
        hr.mt-5
        h4 Nómina
        P Es un soporte contable en el cual la empresa respalda el pago de empleados por concepto de sueldos a los colaboradores de la empresa de forma mensual, quincenal, cada diez días o, como se haya pactado el pago de sueldos.
        ...
        hr.my-5
        h4 Planilla integrada de liquidación de aportes
    ...
    hr.my-5
    h4 Recibo de transferencia de fondos y pago interbancario
    p Es una forma de agilizar negocios entre las entidades financieras y/o clientes. Actualmente se utilizan con mayor frecuencia, teniendo en cuenta que se realiza desde un dispositivo móvil con acceso a internet, que genera garantía y seguridad en el momento de realizar la transacción.
    ...
    hr.my-5
    h4 Recibos de caja menor
    P Las empresas necesitan realizar pagos mínimos, acorde con los montos establecidos y registrados en las políticas contables y en la resolución interna, llamada gastos de caja menor. Allí se establecen los numerales de pago, los montos y la persona responsable del manejo de dicho fondo
    ...
    hr.mt-5
    h4.mb-5 Notas débito y crédito
    h5 Nota debito:
    ...
    hr.my-5
    h4 Comprobantes de contabilidad
    p.mt-3 Representa la base en la elaboración de estados financieros, como resultado debe presentar sumas iguales en los débitos y créditos de una transacción comercial.
      ...
      .row.justify-content-center.align-items-center.mt-5
        ...
        .col
            ...
            h5 Son ejemplos de comprobantes de contabilidad:
    ...
    p El Código de Comercio define los títulos valores como:
      ...
      h5 Características:
      p Según el Código del Comercio (Secretaría del Senado, 2020. Art. 622):
      br
      ...
      br
      h5 Clases
      p Según el Código Comercio, se encuentran títulos: nominativos, a la orden y al portador.
