export default {
  ...
  complementario: [
    {
      texto:
        'Anexo 6 de 2019 al Decreto Único Reglamentario DUR 2420. Titulo Tercero artículos 5,6,7,8,9 y 10.',
      tipo: 'Aspx',
      link:
    ...
    {
      texto: 'Ley 594 de 2000. Ley general de archivos.',
      tipo: 'Web',
      link: 'https://normativa.archivogeneral.gov.co/ley-594-de-2000/',
    },
    {
      texto:
        'Resolución 8934 de 2014. Resolución, aplicable a gestión documental para entidades privadas.',
      tipo: 'Web',
